...
public class BasicBehaviour : MonoBehaviour
{
	...
	private Camera camScript;                // Reference to the third person camera script.
	...
	public Camera GetCamScript { get { return camScript; } }
	...
	void Awake ()
	{
		...
		camScript = playerCamera.GetComponent<Camera> ();
